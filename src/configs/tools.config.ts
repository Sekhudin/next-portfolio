import { BaseTools } from 'src/types/configs';

export const LANGUAGES: BaseTools = {
...
export const FRAMEWORKS: BaseTools = {
  title: 'Frameworks',
  stacks: [
    {
      display: 'Next.js',
...
export const TOOLS: BaseTools[] = [LANGUAGES, FRAMEWORKS, DEVTOOLS];
